...
export const ar = {
  ...
  customerDetails: {
    ...
    itemSalesHistory: "سجل مبيعات الصنف",
  },

  itemSalesHistoryModal: {
    title: "سجل مبيعات الصنف",
    searchPlaceholder: "اكتب اسم الصنف / السماكة (مثال: 8 ملم) / الأبعاد (مثال: 225*321) ثم اضغط Enter",
    customer: "العميل",
    ...
    vat: "% الضريبة",
    date: "التاريخ",
    noResults: "لا توجد مبيعات. جرّب بحثاً مختلفاً.",
    loading: "جارِ التحميل...",
    previous: "→ السابق",
    next: "التالي ←",
    pageInfo: "صفحة {page} من {pages} ({total} نتيجة)",
    showingCount: "عرض {shown} من {total} نتيجة",
    loadMore: "تحميل المزيد",
    loadingMore: "جارِ تحميل المزيد...",
  },
