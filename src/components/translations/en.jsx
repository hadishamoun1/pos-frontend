...
export const en = {
  ...
  customerDetails: {
    ...
    itemSalesHistory: "Item Sales History",
  },

  itemSalesHistoryModal: {
    title: "Item Sales History",
    searchPlaceholder: "Type item name / thickness (e.g. 8 ملم) / dimension (e.g. 225*321), then press Enter",
    customer: "Customer",
    ...
    vat: "VAT %",
    date: "Date",
    noResults: "No sales found. Try a different search.",
    loading: "Loading...",
    previous: "← Previous",
    next: "Next →",
