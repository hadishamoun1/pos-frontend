...
const sections = [
  { name: 'POS System', image: '/path/to/pos-system-image.jpg' },
    ...
    <div className="dashboard-container">
      ...
      <div className="card-grid">
        {sections.map((section, index) => (
          <Link to={`/${section.name.toLowerCase().replace(' ', '-')}`} key={index} className="dashboard-card-link">
            <div className="dashboard-card">
              <img src={section.image} alt={section.name} className="card-image" />
